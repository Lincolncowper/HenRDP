...
:: Menambahkan entri registri untuk mengubah nama komputer dan informasi OEM
...
REG ADD HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation /v SupportURL /t REG_SZ /d "https://github.com/HenCoders/HenRDP/issues" /f

:: Menambahkan pengaturan taskbar dan memulai explorer
